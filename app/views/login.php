        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5 mt-5">
                    <h2 class="heading-section">Sign In<br><br><span class="mb-4 text-center"; style="font-size:16px; color:orange"><?php check_error() ?></span></h2>
                </div>
            </div>
            <div class="row justify-content-center">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-12 text-center">
                                        <button type="submit" class="btn btn-warning rounded submit p-2 mt-2">Enter</button>
                                    </div>
                                </div>
                            </div>
                                </form>
                                    <div class="w-100 social-wrap">
                                      ...
                                      <p class="mt-4 col-md-12 text-center">Not a member Yet? <a href="<?= ROOT ?>register">Register now!</a></p>
                             </div>
                    </div>
                </div>
            </div>
